...
% 4 factors (interval * direction * magnitude * group)
 ph400_rate_ini_int_dir_mag_gro = rate_ini_t6_n15_con;
 ph400_rate_ini_int_dir_mag_gro(1:length(rate_ini_t6_n3_con),10:18) = rate_ini_t6_n3_con;
 ph400_rate_ini_int_dir_mag_gro(1:length(rate_ini_t6_p15_con),19:27) = rate_ini_t6_p15_con;
 ph400_rate_ini_int_dir_mag_gro(1:length(rate_ini_t6_p3_con),28:36) = rate_ini_t6_p3_con;
 
 ph400_rate_locs_int_dir_mag_gro = rate_locs_t6_n15_con;
 ph400_rate_locs_int_dir_mag_gro(1:length(rate_locs_t6_n3_con),10:18) = rate_locs_t6_n3_con;
 ph400_rate_locs_int_dir_mag_gro(1:length(rate_locs_t6_p15_con),19:27) = rate_locs_t6_p15_con;
 ph400_rate_locs_int_dir_mag_gro(1:length(rate_locs_t6_p3_con),28:36) = rate_locs_t6_p3_con;


 ph400_rate_pks_int_dir_mag_gro = rate_pks_t6_n15_con;
 ph400_rate_pks_int_dir_mag_gro(1:length(rate_pks_t6_n3_con),10:18) = rate_pks_t6_n3_con;
 ph400_rate_pks_int_dir_mag_gro(1:length(rate_pks_t6_p15_con),19:27) = rate_pks_t6_p15_con;
 ph400_rate_pks_int_dir_mag_gro(1:length(rate_pks_t6_p3_con),28:36) = rate_pks_t6_p3_con;

 
  % 3 factors (interval * direction * group)
 ph400_rate_ini_int_dir_gro = rate_ini_t6_n15_con;
 ph400_rate_ini_int_dir_gro(1:length(rate_ini_t6_p15_con),10:18) = rate_ini_t6_p15_con;
 
 ph400_rate_locs_int_dir_gro = rate_locs_t6_n15_con;
 ph400_rate_locs_int_dir_gro(1:length(rate_locs_t6_p15_con),10:18) = rate_locs_t6_p15_con;
 
 ph400_rate_pks_int_dir_gro = rate_pks_t6_n15_con;
 ph400_rate_pks_int_dir_gro(1:length(rate_pks_t6_p15_con),10:18) = rate_pks_t6_p15_con;
 
% mus  
% 4 factors (interval * direction * magnitude * group)
 ph400_rate_ini_int_dir_mag_gro(30:29+length(rate_ini_t6_n15_mus),1:9) = rate_ini_t6_n15_mus;
 ph400_rate_ini_int_dir_mag_gro(30:29+length(rate_ini_t6_n3_mus),10:18) = rate_ini_t6_n3_mus;
 ph400_rate_ini_int_dir_mag_gro(30:29+length(rate_ini_t6_p15_mus),19:27) = rate_ini_t6_p15_mus;
 ph400_rate_ini_int_dir_mag_gro(30:29+length(rate_ini_t6_p3_mus),28:36) = rate_ini_t6_p3_mus;
 
 ph400_rate_locs_int_dir_mag_gro(30:29+length(rate_locs_t6_n15_mus),1:9) = rate_locs_t6_n15_mus;
 ph400_rate_locs_int_dir_mag_gro(30:29+length(rate_locs_t6_n3_mus),10:18) = rate_locs_t6_n3_mus;
 ph400_rate_locs_int_dir_mag_gro(30:29+length(rate_locs_t6_p15_mus),19:27) = rate_locs_t6_p15_mus;
 ph400_rate_locs_int_dir_mag_gro(30:29+length(rate_locs_t6_p3_mus),28:36) = rate_locs_t6_p3_mus;

 ph400_rate_pks_int_dir_mag_gro(30:29+length(rate_pks_t6_n15_mus),1:9) = rate_pks_t6_n15_mus;
 ph400_rate_pks_int_dir_mag_gro(30:29+length(rate_pks_t6_n3_mus),10:18) = rate_pks_t6_n3_mus;
 ph400_rate_pks_int_dir_mag_gro(30:29+length(rate_pks_t6_p15_mus),19:27) = rate_pks_t6_p15_mus;
 ph400_rate_pks_int_dir_mag_gro(30:29+length(rate_pks_t6_p3_mus),28:36) = rate_pks_t6_p3_mus;

 
  % 3 factors (interval * direction * group)
  
 ph400_rate_ini_int_dir_gro(30:29+length(rate_ini_t6_n15_mus),1:9) = rate_ini_t6_n15_mus;
 ph400_rate_ini_int_dir_gro(30:29+length(rate_ini_t6_p15_mus),10:18) = rate_ini_t6_p15_mus;
 
 ph400_rate_locs_int_dir_gro(30:29+length(rate_locs_t6_n15_mus),1:9) = rate_locs_t6_n15_mus;
 ph400_rate_locs_int_dir_gro(30:29+length(rate_locs_t6_p15_mus),10:18) = rate_locs_t6_p15_mus;
 
 ph400_rate_pks_int_dir_gro(30:29+length(rate_pks_t6_n15_mus),1:9) = rate_pks_t6_n15_mus;
 ph400_rate_pks_int_dir_gro(30:29+length(rate_pks_t6_p15_mus),10:18) = rate_pks_t6_p15_mus;
...
csvwrite('ph400_rate_ini_int_dir_mag_gro.csv',ph400_rate_ini_int_dir_mag_gro);
csvwrite('ph400_rate_ini_int_dir_gro.csv',ph400_rate_ini_int_dir_gro);

csvwrite('ph400_rate_locs_int_dir_mag_gro.csv',ph400_rate_locs_int_dir_mag_gro);
csvwrite('ph400_rate_locs_int_dir_gro.csv',ph400_rate_locs_int_dir_gro);

csvwrite('ph400_rate_pks_int_dir_mag_gro.csv',ph400_rate_pks_int_dir_mag_gro);
csvwrite('ph400_rate_pks_int_dir_gro.csv',ph400_rate_pks_int_dir_gro);
