    ...
    try 
        ...
        sound = dataArray{:, 3};
         ...
         if (find(timeus==0) ~= 0) 
            ...
            voltfsrv = voltfsrv(1:end-2700); %delete 2 peaks from the end for ph800 (맨 뒤에 신호가 막 겹쳐서 나오는 경우 error) 
            timeus = timeus(1:end-2700);
            sound = sound(1:end-2700);
...
% % % 
    ...
    trialidx=find((ts_sound_re.data(2:end)-ts_sound_re.data(1:end-1))==1); %뒤에서 앞에꺼 뺀게 1인걸 찾아라 (1일때 소리있는거고 0일때 없는거니)
...
% % %     plot(ts_sound_re.time(trialidx(1:end-1)+iti),.5,'o')
    ...
    %% epoching
    epoch_idx_key=trialidx(1:end-1)+iti; %epoch 자르려고 iti 만큼 민 것.  
...
%     plot(transpose(filtered_volt(epoch_idx_key(n)-len:epoch_idx_key(n))));
    ...
    for n=1:length(epoch_onset)
        epoch_onset_a(ei,:) = epoch_onset(n,:)+epoch_idx_key(n)-len-1; %갯수하나씩 모자르거나 할때 더하고 뺀것 -1은 index 하나 뺀것 
        ei=ei+1;
    end
...
% % % 
    ...
    %% find target point 
    %ph400
    var_n15_idx_key=((iti_array>=676)&(iti_array<=685));
    var_n3_idx_key=((iti_array>=772)&(iti_array<=781));
    var_p15_idx_key=((iti_array>=916)&(iti_array<=925));
    var_p3_idx_key=((iti_array>=820)&(iti_array<=829));
    ...
    % dummy (complate script 이후 아래 네줄만 업데이트함!)
    var_idx_t7(1,1:4) = 0
    var_idx_t6(1,1:4) = 0
    var_idx_t5(1,1:4) = 0
    var_idx_t4(1,1:4) = 0
...
%         'epoch_idx_key','epoch_onset','epoch_locs','len','filtered_volt','ini_m*','locs_m*','pks_m*','trialidx','var_*')
    ...
    % ini
    ini_m_t4_n15_all{nu,1} = filename;
    ini_m_t4_n15_all(nu,3:11) = num2cell(ini_m_t4_n15(1,:));
    ini_m_t4_n15_all{nu,2} = length(var_ini_t4_n15(:,1));
    
    ini_m_t5_n15_all{nu,1} = filename;
    ini_m_t5_n15_all(nu,3:12) = num2cell(ini_m_t5_n15(1,:));
    ini_m_t5_n15_all{nu,2} = length(var_ini_t5_n15(:,1)); 
    
    ini_m_t6_n15_all{nu,1} = filename;
    ini_m_t6_n15_all(nu,3:13) = num2cell(ini_m_t6_n15(1,:));
    ini_m_t6_n15_all{nu,2} = length(var_ini_t6_n15(:,1));
 
    ini_m_t7_n15_all{nu,1} = filename;
    ini_m_t7_n15_all(nu,3:14) = num2cell(ini_m_t7_n15(1,:));
    ini_m_t7_n15_all{nu,2} = length(var_ini_t7_n15(:,1));
    
    % locs 

    locs_m_t4_n15_all{nu,1} = filename;
    locs_m_t4_n15_all(nu,3:11) = num2cell(locs_m_t4_n15(1,:));
    locs_m_t4_n15_all{nu,2} = length(var_locs_t4_n15(:,1));
    
    locs_m_t5_n15_all{nu,1} = filename;
    locs_m_t5_n15_all(nu,3:12) = num2cell(locs_m_t5_n15(1,:));
    locs_m_t5_n15_all{nu,2} = length(var_locs_t5_n15(:,1)); 
    
    locs_m_t6_n15_all{nu,1} = filename;
    locs_m_t6_n15_all(nu,3:13) = num2cell(locs_m_t6_n15(1,:));
    locs_m_t6_n15_all{nu,2} = length(var_locs_t6_n15(:,1));
 
    locs_m_t7_n15_all{nu,1} = filename;
    locs_m_t7_n15_all(nu,3:14) = num2cell(locs_m_t7_n15(1,:));
    locs_m_t7_n15_all{nu,2} = length(var_locs_t7_n15(:,1));
    
    % pks 
    pks_m_t4_n15_all{nu,1} = filename;
    pks_m_t4_n15_all(nu,3:11) = num2cell(pks_m_t4_n15(1,:));
    pks_m_t4_n15_all{nu,2} = length(var_pks_t4_n15(:,1));
    
    pks_m_t5_n15_all{nu,1} = filename;
    pks_m_t5_n15_all(nu,3:12) = num2cell(pks_m_t5_n15(1,:));
    pks_m_t5_n15_all{nu,2} = length(var_pks_t5_n15(:,1)); 
    
    pks_m_t6_n15_all{nu,1} = filename;
    pks_m_t6_n15_all(nu,3:13) = num2cell(pks_m_t6_n15(1,:));
    pks_m_t6_n15_all{nu,2} = length(var_pks_t6_n15(:,1));
 
    pks_m_t7_n15_all{nu,1} = filename;
    pks_m_t7_n15_all(nu,3:14) = num2cell(pks_m_t7_n15(1,:));
    pks_m_t7_n15_all{nu,2} = length(var_pks_t7_n15(:,1));
    


    % ini
    ini_m_t4_n3_all{nu,1} = filename;
    ini_m_t4_n3_all(nu,3:11) = num2cell(ini_m_t4_n3(1,:));
    ini_m_t4_n3_all{nu,2} = length(var_ini_t4_n3(:,1));
    
    ini_m_t5_n3_all{nu,1} = filename;
    ini_m_t5_n3_all(nu,3:12) = num2cell(ini_m_t5_n3(1,:));
    ini_m_t5_n3_all{nu,2} = length(var_ini_t5_n3(:,1)); 
    
    ini_m_t6_n3_all{nu,1} = filename;
    ini_m_t6_n3_all(nu,3:13) = num2cell(ini_m_t6_n3(1,:));
    ini_m_t6_n3_all{nu,2} = length(var_ini_t6_n3(:,1));
 
    ini_m_t7_n3_all{nu,1} = filename;
    ini_m_t7_n3_all(nu,3:14) = num2cell(ini_m_t7_n3(1,:));
    ini_m_t7_n3_all{nu,2} = length(var_ini_t7_n3(:,1));
    
    % locs 
 
    locs_m_t4_n3_all{nu,1} = filename;
    locs_m_t4_n3_all(nu,3:11) = num2cell(locs_m_t4_n3(1,:));
    locs_m_t4_n3_all{nu,2} = length(var_locs_t4_n3(:,1));
    
    locs_m_t5_n3_all{nu,1} = filename;
    locs_m_t5_n3_all(nu,3:12) = num2cell(locs_m_t5_n3(1,:));
    locs_m_t5_n3_all{nu,2} = length(var_locs_t5_n3(:,1)); 
    
    locs_m_t6_n3_all{nu,1} = filename;
    locs_m_t6_n3_all(nu,3:13) = num2cell(locs_m_t6_n3(1,:));
    locs_m_t6_n3_all{nu,2} = length(var_locs_t6_n3(:,1));
 
    locs_m_t7_n3_all{nu,1} = filename;
    locs_m_t7_n3_all(nu,3:14) = num2cell(locs_m_t7_n3(1,:));
    locs_m_t7_n3_all{nu,2} = length(var_locs_t7_n3(:,1));
    
    % pks 
    pks_m_t4_n3_all{nu,1} = filename;
    pks_m_t4_n3_all(nu,3:11) = num2cell(pks_m_t4_n3(1,:));
    pks_m_t4_n3_all{nu,2} = length(var_pks_t4_n3(:,1));
    
    pks_m_t5_n3_all{nu,1} = filename;
    pks_m_t5_n3_all(nu,3:12) = num2cell(pks_m_t5_n3(1,:));
    pks_m_t5_n3_all{nu,2} = length(var_pks_t5_n3(:,1)); 
    
    pks_m_t6_n3_all{nu,1} = filename;
    pks_m_t6_n3_all(nu,3:13) = num2cell(pks_m_t6_n3(1,:));
    pks_m_t6_n3_all{nu,2} = length(var_pks_t6_n3(:,1));
 
    pks_m_t7_n3_all{nu,1} = filename;
    pks_m_t7_n3_all(nu,3:14) = num2cell(pks_m_t7_n3(1,:));
    pks_m_t7_n3_all{nu,2} = length(var_pks_t7_n3(:,1));
 

    % ini
    ini_m_t4_p15_all{nu,1} = filename;
    ini_m_t4_p15_all(nu,3:11) = num2cell(ini_m_t4_p15(1,:));
    ini_m_t4_p15_all{nu,2} = length(var_ini_t4_p15(:,1));
    
    ini_m_t5_p15_all{nu,1} = filename;
    ini_m_t5_p15_all(nu,3:12) = num2cell(ini_m_t5_p15(1,:));
    ini_m_t5_p15_all{nu,2} = length(var_ini_t5_p15(:,1)); 
    
    ini_m_t6_p15_all{nu,1} = filename;
    ini_m_t6_p15_all(nu,3:13) = num2cell(ini_m_t6_p15(1,:));
    ini_m_t6_p15_all{nu,2} = length(var_ini_t6_p15(:,1));
 
    ini_m_t7_p15_all{nu,1} = filename;
    ini_m_t7_p15_all(nu,3:14) = num2cell(ini_m_t7_p15(1,:));
    ini_m_t7_p15_all{nu,2} = length(var_ini_t7_p15(:,1));
    
    % locs 
 
    locs_m_t4_p15_all{nu,1} = filename;
    locs_m_t4_p15_all(nu,3:11) = num2cell(locs_m_t4_p15(1,:));
    locs_m_t4_p15_all{nu,2} = length(var_locs_t4_p15(:,1));
    
    locs_m_t5_p15_all{nu,1} = filename;
    locs_m_t5_p15_all(nu,3:12) = num2cell(locs_m_t5_p15(1,:));
    locs_m_t5_p15_all{nu,2} = length(var_locs_t5_p15(:,1)); 
    
    locs_m_t6_p15_all{nu,1} = filename;
    locs_m_t6_p15_all(nu,3:13) = num2cell(locs_m_t6_p15(1,:));
    locs_m_t6_p15_all{nu,2} = length(var_locs_t6_p15(:,1));
 
    locs_m_t7_p15_all{nu,1} = filename;
    locs_m_t7_p15_all(nu,3:14) = num2cell(locs_m_t7_p15(1,:));
    locs_m_t7_p15_all{nu,2} = length(var_locs_t7_p15(:,1));
    
    % pks 
    pks_m_t4_p15_all{nu,1} = filename;
    pks_m_t4_p15_all(nu,3:11) = num2cell(pks_m_t4_p15(1,:));
    pks_m_t4_p15_all{nu,2} = length(var_pks_t4_p15(:,1));
    
    pks_m_t5_p15_all{nu,1} = filename;
    pks_m_t5_p15_all(nu,3:12) = num2cell(pks_m_t5_p15(1,:));
    pks_m_t5_p15_all{nu,2} = length(var_pks_t5_p15(:,1)); 
    
    pks_m_t6_p15_all{nu,1} = filename;
    pks_m_t6_p15_all(nu,3:13) = num2cell(pks_m_t6_p15(1,:));
    pks_m_t6_p15_all{nu,2} = length(var_pks_t6_p15(:,1));
 
    pks_m_t7_p15_all{nu,1} = filename;
    pks_m_t7_p15_all(nu,3:14) = num2cell(pks_m_t7_p15(1,:));
    pks_m_t7_p15_all{nu,2} = length(var_pks_t7_p15(:,1));


    % ini
    ini_m_t4_p3_all{nu,1} = filename;
    ini_m_t4_p3_all(nu,3:11) = num2cell(ini_m_t4_p3(1,:));
    ini_m_t4_p3_all{nu,2} = length(var_ini_t4_p3(:,1));
    
    ini_m_t5_p3_all{nu,1} = filename;
    ini_m_t5_p3_all(nu,3:12) = num2cell(ini_m_t5_p3(1,:));
    ini_m_t5_p3_all{nu,2} = length(var_ini_t5_p3(:,1)); 
    
    ini_m_t6_p3_all{nu,1} = filename;
    ini_m_t6_p3_all(nu,3:13) = num2cell(ini_m_t6_p3(1,:));
    ini_m_t6_p3_all{nu,2} = length(var_ini_t6_p3(:,1));
 
    ini_m_t7_p3_all{nu,1} = filename;
    ini_m_t7_p3_all(nu,3:14) = num2cell(ini_m_t7_p3(1,:));
    ini_m_t7_p3_all{nu,2} = length(var_ini_t7_p3(:,1));
    
    % locs 
 
    locs_m_t4_p3_all{nu,1} = filename;
    locs_m_t4_p3_all(nu,3:11) = num2cell(locs_m_t4_p3(1,:));
    locs_m_t4_p3_all{nu,2} = length(var_locs_t4_p3(:,1));
    
    locs_m_t5_p3_all{nu,1} = filename;
    locs_m_t5_p3_all(nu,3:12) = num2cell(locs_m_t5_p3(1,:));
    locs_m_t5_p3_all{nu,2} = length(var_locs_t5_p3(:,1)); 
    
    locs_m_t6_p3_all{nu,1} = filename;
    locs_m_t6_p3_all(nu,3:13) = num2cell(locs_m_t6_p3(1,:));
    locs_m_t6_p3_all{nu,2} = length(var_locs_t6_p3(:,1));
 
    locs_m_t7_p3_all{nu,1} = filename;
    locs_m_t7_p3_all(nu,3:14) = num2cell(locs_m_t7_p3(1,:));
    locs_m_t7_p3_all{nu,2} = length(var_locs_t7_p3(:,1));
    
    % pks 
    pks_m_t4_p3_all{nu,1} = filename;
    pks_m_t4_p3_all(nu,3:11) = num2cell(pks_m_t4_p3(1,:));
    pks_m_t4_p3_all{nu,2} = length(var_pks_t4_p3(:,1));
    
    pks_m_t5_p3_all{nu,1} = filename;
    pks_m_t5_p3_all(nu,3:12) = num2cell(pks_m_t5_p3(1,:));
    pks_m_t5_p3_all{nu,2} = length(var_pks_t5_p3(:,1)); 
    
    pks_m_t6_p3_all{nu,1} = filename;
    pks_m_t6_p3_all(nu,3:13) = num2cell(pks_m_t6_p3(1,:));
    pks_m_t6_p3_all{nu,2} = length(var_pks_t6_p3(:,1));
 
    pks_m_t7_p3_all{nu,1} = filename;
    pks_m_t7_p3_all(nu,3:14) = num2cell(pks_m_t7_p3(1,:));
    pks_m_t7_p3_all{nu,2} = length(var_pks_t7_p3(:,1));
...
%% saving result_all
save('ph400_all.mat', '*_all');

%% saving variables

% var = ini_m_t4_n15_all 
% file = 'ini_m_t4_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e\n', var{row,:});
% end
% fclose(fid);
% 
% var = ini_m_t4_n3_all 
% file = 'ini_m_t4_n3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
% 
% var = ini_m_t4_p15_all 
% file = 'ini_m_t4_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% 
%  
% var = ini_m_t5_n15_all 
% file = 'ini_m_t5_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
% end
% fclose(fid);
%  
% var = ini_m_t5_n3_all 
% file = 'ini_m_t5_n3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = ini_m_t5_p15_all 
% file = 'ini_m_t5_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% 
%  
% var = ini_m_t6_n15_all 
% file = 'ini_m_t6_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
% end
% fclose(fid);
%  
% var = ini_m_t6_n3_all 
% file = 'ini_m_t6_n3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = ini_m_t6_p15_all 
% file = 'ini_m_t6_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% 
%  
% var = ini_m_t7_n15_all 
% file = 'ini_m_t7_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
% end
% fclose(fid);
%  
% var = ini_m_t7_n3_all 
% file = 'ini_m_t7_n3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = ini_m_t7_p15_all 
% file = 'ini_m_t7_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% 
%  
% var = locs_m_t4_n15_all 
% file = 'locs_m_t4_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t4_n3_all 
% file = 'locs_m_t4_n3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t4_p15_all 
% file = 'locs_m_t4_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t4_p3_all 
% file = 'locs_m_t4_p3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
%  
%  
% var = locs_m_t5_n15_all 
% file = 'locs_m_t5_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t5_n3_all 
% file = 'locs_m_t5_n3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t5_p15_all 
% file = 'locs_m_t5_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t5_p3_all 
% file = 'locs_m_t5_p3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
%  
%  
% var = locs_m_t6_n15_all 
% file = 'locs_m_t6_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t6_n3_all 
% file = 'locs_m_t6_n3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t6_p15_all 
% file = 'locs_m_t6_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t6_p3_all 
% file = 'locs_m_t6_p3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
%  
%  
% var = locs_m_t7_n15_all 
% file = 'locs_m_t7_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t7_n3_all 
% file = 'locs_m_t7_n3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t7_p15_all 
% file = 'locs_m_t7_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = locs_m_t7_p3_all 
% file = 'locs_m_t7_p3_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% 
%  
% var = pks_m_t4_n15_all 
% file = 'pks_m_t4_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = pks_m_t4_p15_all 
% file = 'pks_m_t4_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
%  
%  
% var = pks_m_t5_n15_all 
% file = 'pks_m_t5_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = pks_m_t5_p15_all 
% file = 'pks_m_t5_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
%  
%  
% var = pks_m_t6_n15_all 
% file = 'pks_m_t6_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = pks_m_t6_p15_all 
% file = 'pks_m_t6_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
%  
%  
% var = pks_m_t7_n15_all 
% file = 'pks_m_t7_n15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
...
% fclose(fid);
%  
% var = pks_m_t7_p15_all 
% file = 'pks_m_t7_p15_all.txt'
% [nrows,ncols]=size(var)
% fid = fopen(file, 'w');
% for row=1:nrows
%     fprintf(fid, '%s %g %e %e %e %e %e %e %e %e %e %e %e %e\n', var{row,:});
