    ...
    try 
        ...
        sound = dataArray{:, 3};
         ...
         if (find(timeus==0) ~= 0) 
            ...
            voltfsrv = voltfsrv(1:end-5400); %delete 2 peaks from the end for ph800 (맨 뒤에 신호가 막 겹쳐서 나오는 경우 error) 
            timeus = timeus(1:end-5400);
            sound = sound(1:end-5400);
...
% % %     end
    ...
    %% find target point 
    %ph800
    var_n15_idx_key=((iti_array>=1356)&(iti_array<=1365));
    var_n3_idx_key=((iti_array>=1548)&(iti_array<=1557));
    var_p15_idx_key=((iti_array>=1836)&(iti_array<=1845));
    var_p3_idx_key=((iti_array>=1644)&(iti_array<=1653));
